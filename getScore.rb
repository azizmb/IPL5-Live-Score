...
print "#{ score["matchInfo"]["teams"][playing1st]["team"]["abbreviation"] } : #{ score["innings"][0]["scorecard"]["runs"] }/#{ score["innings"][0]["scorecard"]["wkts"] }(#{ score["innings"][0]["overProgress"] })\n"
print "#{ score["matchInfo"]["teams"][playing2nd]["team"]["abbreviation"] } : " 
if !score["innings"][1].nil?
    print "#{ score["innings"][1]["scorecard"]["runs"] }/#{score["innings"][1]["scorecard"]["wkts"]} (#{ score["innings"][1]["overProgress"] })"
end
print "\n"
